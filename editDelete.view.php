          ...
          <tbody>
            <?php foreach($result as $account): ?>
              <tr>
                ...
                <td><a href="editForm.php?id=<?php echo $account->id ?>" class="btn btn-warning form-control">Edit</a></td>
                <td><a href="deleteAccount.php?id=<?php echo $account->id ?>" class="btn btn-danger form-control">Delete</a></td>
              </tr>
            <?php endforeach ?>
          </tbody>
        </table>
